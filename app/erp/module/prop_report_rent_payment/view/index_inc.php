						...
						?>						
							...
							<span class="formRow">
								...
								<span class="formInput" data-remarks="(dd/mm/yyyy)">
									<input id="payment_date_from" class="datepicker" style="width: 140px" type="text" name="criteria[inv_date_from]" autocomplete="off" value="<?php echo $criteria['[payment_date_from'];?>" placeholder="dd/mm/yyyy" maxlength="10">
								</span>
							</span>
							<span class="formRow">
							</span>							
							...
							<span class="formRow">
								<span class="formLabel">
									<label class="">Payment Date To :</label>
								</span>
								<span class="formInput" data-remarks="(dd/mm/yyyy)">
									<input id="payment_date_to" class="datepicker" style="width: 140px" type="text" name="criteria[inv_date_to]" autocomplete="off" value="<?php echo $criteria['payment_date_to'];?>" placeholder="dd/mm/yyyy" maxlength="10">
								</span>
							</span>
							<span class="formRow">
							</span>							
