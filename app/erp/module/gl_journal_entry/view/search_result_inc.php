					...
					<div class="sidebarContentCol" id="TransactionsDiv">
						...
						<table class="searchResult" border="0" cellspacing="0" cellpadding="0">
							<tbody>
								...
								<th style="text-align:left" width ="10%'">Journal Date</th>
								<th style="text-align:left" width ="18%'">Journal Code</th>
								<th style="text-align:right" width ="">Balance</th>
								<th style="text-align:left" width ="12%'">Posting</th>
								<th style="text-align:left" width ="6%'">Year End</th>
								...
								if ($arr_count_general_model >0){
									...
									foreach ($arr_general_model as $general_model): 
										...
										echo number_format($general_model['balance'],2);
										echo '</td>';
										if($balance<>0) echo '</font>';		
										echo '<td>';		switch($general_model['posting_is']) {
										...
										echo '<td>';		switch($general_model['year_end_is']) {
