								...
								<table class="searchResult" border="0" cellspacing="0" cellpadding="0">
									<tbody>
										...
										<?php
											$balance = 0;
											$i_count=1;
											foreach ($arr_rent_transactions as $rent_transaction): 
												if ($rent_transaction['status']==1) {
													$balance +=$rent_transaction['balance'];
													}	
													
												if ($rent_transaction['status']==1)  echo '<tr>';
												if ($rent_transaction['status']==0)  echo '<tr style="background: #D1D0CE;">';
												...
												echo '</td>';														
												echo '<td style="text-align:left">';
												echo YMDtoDMY($rent_transaction['period_date_to']);
												echo '</td>';																									echo '<td style="text-align:right">';
												echo number_format($rent_transaction['amount'],2);
												echo '</td>';		
												
												echo '<td style="text-align:right">';
												echo number_format($rent_transaction['balance'],2);
												echo '</td>';
				
												echo '<td>';	
												switch($rent_transaction['status']) {
