...
$inputFileType = 'Xlsx';
$inputFileName = 'prop_report_maint_debit_note_template_v01.xlsx';
$sheetname = ['sheet1'];
...
$sheet->setCellValue(('K'.$excel_row), ($report_ttl));	
$sheet ->getStyle(('J'.$excel_row.':J'.$excel_row))->applyFromArray($styleArray);
$sheet ->getStyle(('K'.$excel_row.':K'.$excel_row))->applyFromArray($styleArray);
...
$file_name = 'prop_report_maint_debit_note_'.$dt->format('Y-m-d_H_i_s').'.xlsx';
