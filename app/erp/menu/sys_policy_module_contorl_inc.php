...
<UL>
  <LI class="main_menu_selected">System Security Policy Menu</LI>';
  /*
...
echo '<LI class="main_menu_unselected"><a href="/'.IS_PORTAL.'/'.IS_LANG.'/sys_policy/new">Module Control</a></LI>';
echo '<a href="'.actionURL('search','?lot_id='.$lot_id.'&page='.$x).'" class="pageResults">';
}
