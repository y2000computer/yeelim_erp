<?php
class prop_report_rent_payment_model  extends dataManager          
{
	private $dbh;
    ...
    {
		parent::__construct();
    	$this->errorMsg='PROP -> Report -> Rent Payment Report -> SQL error:';
     	$this->setErrorMsg('PROP -> Report -> Rent Payment Report -> SQL error:');
