<?php
class prop_report_rent_inv_model  extends dataManager        
{
	private $dbh;
    ...
    {
		parent::__construct();
    	$this->errorMsg='PROP -> Report -> Rent Invoice Report -> SQL error:';
     	$this->setErrorMsg('PROP -> Report -> Rent Invoice Report -> SQL error:');
