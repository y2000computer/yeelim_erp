<?php
class prop_rent_inv_model extends dataManager
{
	private $dbh;
    ...
    {
		parent::__construct();
    	$this->errorMsg='PROP -> Transaction -> Rent Invoice -> SQL error:';
    	$this->mainTable='tbl_prop_rent_inv';
    	$this->setTable('tbl_prop_rent_inv');
    	$this->setErrorMsg('PROP -> Transaction -> Rent Invoice -> SQL error:');
    	$this->logField= null;
