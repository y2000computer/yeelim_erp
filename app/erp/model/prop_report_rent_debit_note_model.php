<?php
class prop_report_rent_debit_note_model  extends dataManager      
{
	private $dbh;
    ...
    {
		parent::__construct();
    	$this->errorMsg='PROP -> Report -> Rent Debit Note -> SQL error:';
     	$this->setErrorMsg('PROP -> Report -> Rent Debit Note -> SQL error:');
